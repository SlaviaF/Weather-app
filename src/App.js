...
function App() {
  ...
  return (
    <div className='w-full h-screen bg-hero bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0' >
      <form className='h-14 bg-black/30 w-full max-w-[450px] rounded-full backdrop-blur-[32px] mb-8'>
      ...
      <div className='mt-2 w-full max-w-[450px]  bg-black/50 min-h-[450px] text-white rounded-2xl backrop-blur-md py-12 px-6'>
