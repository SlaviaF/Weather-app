...
function App() {
  ...
  return (
    <div className='h-screen w-full' >
      <div className='bg-hero bg-cover bg-center w-full h-full flex flex-col items-center sm:justify-center p-4'>
        <form className='max-h-14 bg-black/30 w-full max-w-[450px] rounded-full backdrop-blur-[32px] my-4'>
